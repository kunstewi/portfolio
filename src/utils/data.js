// --- Imports (Based on the icons used: lucide-react and react-icons/fi) ---
import {
  Code2,
  GraduationCap,
  Briefcase,
...
import { FiGithub, FiLinkedin, FiTwitter } from "react-icons/fi"; // Assuming social icons are from react-icons/fi
...
export const PROJECTS = [
  ...
  },
  {
    ...
    liveUrl: "https://youtu.be/fZKS7PXKC-0",
    githubUrl: "#",
    featured: true,
    category: "Web App",
  },
  {
    ...
    description:
      "A smart AI-powered Interview Preparation App using the MERN stack - along with the Gemini API for interviews.",
    image: PROJECT_IMG_4,
    tags: ["Next.js", "TypeScript", "Node.js", "MongoDB"],
  ...
  },
  {
    ...
    description:
      "A fully functional Resume Builder App using the MERN stack along with Tailwind CSS for a clean, modern design.",
    image: PROJECT_IMG_5,
    tags: ["Next.js", "TypeScript", "Node.js", "MongoDB"],
...
// ====================================================================
// --- JOURNEY_STEPS (Timeline/Experience Data) ---
// ====================================================================
export const JOURNEY_STEPS = [
  ...
  },
  {
    ...
    description:
      "Began a Computer Science degree focusing on algorithms, data structures, and software engineering principles.",
    icon: GraduationCap, // Assuming a suitable icon
  ...
  },
  {
    ...
    company: "Present",
    description:
      "Currently building innovative solutions and exploring new technologies like AI integration and advanced cloud services.",
    icon: Zap,
    color: "bg-cyan-500",
  },
];
